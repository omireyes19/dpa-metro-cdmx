...
class data_acq_task(luigi.Task):
    ...
    def run(self):
        ...
        for day in range(days_in_month):
        	self.fecha = str(self.year)+"-"+str(self.month).zfill(2)+"-"+str(day+1).zfill(2)
    ...
    def output(self):
        output_path = "s3://{}/information_date={}/station={}/{}.json".format(self.bucket,self.fecha,self.station,self.fecha+self.station)
